...
import (
	...
	"github.com/fedora-oss/javinizer-go/internal/api/auth"
	"github.com/fedora-oss/javinizer-go/internal/api/batch"
	"github.com/fedora-oss/javinizer-go/internal/api/core"
	"github.com/fedora-oss/javinizer-go/internal/api/events"
	"github.com/fedora-oss/javinizer-go/internal/api/file"
	"github.com/fedora-oss/javinizer-go/internal/api/genre"
	"github.com/fedora-oss/javinizer-go/internal/api/history"
	"github.com/fedora-oss/javinizer-go/internal/api/jobs"
	"github.com/fedora-oss/javinizer-go/internal/api/middleware"
	...
	"github.com/fedora-oss/javinizer-go/internal/api/temp"
	"github.com/fedora-oss/javinizer-go/internal/api/token"
	apiversion "github.com/fedora-oss/javinizer-go/internal/api/version"
	"github.com/fedora-oss/javinizer-go/internal/logging"
	webui "github.com/fedora-oss/javinizer-go/web"
